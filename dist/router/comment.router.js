...
commentRouter.post('/articles/:id', authenticate_user_1.default, (0, withTryCatch_1.default)(comment_control_1.default.post));
commentRouter.post('/products/:id', authenticate_user_1.default, (0, withTryCatch_1.default)(comment_control_1.default.post));
