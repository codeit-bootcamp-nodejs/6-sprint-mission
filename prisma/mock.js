...
exports.COMMENTS = exports.ARTICLES = exports.PRODUCTS = exports.USERS = void 0;
//----------------------------------------
// USERS: 7명
//----------------------------------------
exports.USERS = [
...
exports.PRODUCTS = [
    ...
    },
    {
        ...
        description: '최신 OLED evo 패널을 사용한 4K HDR 스마트 TV로, 생생한 색감과 얇은 디자인이 특징입니다.',
        price: 2890000,
        tags: ['TV', 'OLED', '가전'],
        imageUrls: [
    ...
    },
    {
        ...
        description: 'Apple의 AirPods 프로는 탁월한 사운드 품질과 노이즈 캔슬링 기능을 갖춘 무선 이어폰입니다.',
        price: 320000,
        tags: ['소음제거', '스마트기기'],
        imageUrls: [
    ...
    },
    {
        ...
        description: '최신 Snapdragon 프로세서와 강력한 카메라 성능을 갖춘 삼성의 프리미엄 스마트폰입니다.',
        price: 1450000,
        tags: ['스마트폰'],
        imageUrls: [
    ...
    },
    {
        ...
        description: '노트북과 태블릿의 장점을 결합한 2-in-1 디바이스로, 생산성과 휴대성을 모두 제공합니다.',
        price: 1890000,
        tags: ['노트북', '태블릿'],
        imageUrls: [
    ...
    },
    {
        ...
        description: '소니의 대표적인 무선 노이즈 캔슬링 헤드폰으로, 탁월한 음질과 편안한 착용감을 제공합니다.',
        price: 420000,
        tags: ['헤드폰', '소음제거'],
        imageUrls: [
            'https://images.unsplash.com/photo-1606813909365-59459a4577d8',
...
exports.ARTICLES = [
    ...
    },
    {
        id: 5,
        title: '인터스텔라',
        content: '인류의 생존을 위해 우주로 떠난 탐사대의 여정을 통해 시간과 사랑의 본질을 탐구하는 SF 명작.',
    ...
    },
    {
        id: 7,
        title: '인셉션',
        content: '꿈속에서 또 다른 꿈을 꾸는 다층 구조의 스릴러. 인간의 무의식과 현실의 경계를 탐험하는 놀란 감독의 대표작.',
        imageUrls: [
    ...
    },
    {
        id: 8,
        title: '포레스트 검프',
        content: '지적 장애를 가진 한 남자의 순수한 시선으로 본 미국 현대사의 여정. 감동적인 인생 드라마.',
    ...
    },
    {
        id: 9,
        title: '기생충',
        content: '부잣집과 가난한 집 두 가족의 교묘한 공생 관계가 결국 파국으로 치닫는 블랙코미디. 사회 계급의 벽을 날카롭게 풍자한다.',
    ...
    },
    {
        id: 16,
        title: '라라랜드',
        content: '꿈을 좇는 두 예술가의 사랑과 현실 사이의 아픔을 그린 뮤지컬 영화. 화려한 색감과 재즈 선율이 매력적이다.',
        imageUrls: [
    ...
    },
    {
        id: 18,
        title: '헤어질 결심',
        content: '의문의 죽음을 조사하던 형사가 피의자 여인에게 빠져드는 미스터리 멜로. 박찬욱 감독의 섬세한 심리극.',
    ...
    },
    {
        id: 20,
        title: '이터널 선샤인',
        content: '잊고 싶은 기억을 지워주는 기술을 소재로, 사랑과 기억의 의미를 되묻는 로맨틱 SF 드라마.',
    ...
    },
    {
        id: 21,
        title: '전망좋은 방',
        content: '20세기 초중반 조신한 영국 처녀가 격정이 넘치는 이태리를 여행하며 성에 눈뜨는 과정을 코믹하게 묘사한 작품',
    ...
    },
    {
        id: 22,
        title: '사촌 비니',
        content: '뉴욕 브루클린 출신의 7전8기 변호사 비니의 좌충우돌 첫 케이스! 비니는 사촌 빈센트의 살인누명을 벗겨줄 수 있을 것인가? 남주 조펫지 여주 마리사 토메이가 환상적인 연기의 궁합을 보이다!',
        imageUrls: [
