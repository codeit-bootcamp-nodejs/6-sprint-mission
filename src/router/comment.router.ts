...
commentRouter.post('/articles/:id', authenticateUser, withTryCatch(commentControl.post));
commentRouter.post('/products/:id', authenticateUser, withTryCatch(commentControl.post));
